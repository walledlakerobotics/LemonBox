...
public class Motor implements AutoCloseable {
    ...
    public Map<String, Object> getProperties() {
        ...
        props.put("amps", Math.round(m_ampSub.get() * 100.0) / 100.0);
        props.put("voltage", Math.round(m_voltageSub.get() * 100.0) / 100.0);
    ...
    public static String[] getMotorIDs(NetworkTable table) {
        return table.getEntry("motorIDs").getStringArray(new String[0]);
    }
