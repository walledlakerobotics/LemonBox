...
public class MotorManager implements AutoCloseable {
    ...
    /**
     * 
     * returns an optional Motor, corresponding to the id of the motor you want to return. 
    ...
    /**
     * Updates or Refreshes the current motors with the table, also closes the past motor subscribers. 
